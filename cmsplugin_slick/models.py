...
class SlickCarouselBreakpoint(models.Model):
    """
    Carousel break point allow create responsive carousels
    """
    carousel = models.ForeignKey('SlickCarousel', related_name='breakpoints', verbose_name=_('Slick carousel'),
...
class SlickCarouselElementWrapper(CMSPlugin):
...
class SlickCaroselImageFolder(CMSPlugin):
    title = models.CharField(_("Title"), max_length=255, null=True, blank=True)
